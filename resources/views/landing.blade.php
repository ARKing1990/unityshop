...
<html lang="en">
    ...
    <body>
        ...
        <!-- Header-->
        <header class="bg-landing py-5">
            <div class="container px-4 px-lg-3 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Style Maven Collection</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Trendsetter Apparel - Fashion Fusion - Casual Cool</p>
                </div>
            </div>
        </header>
        <!--Carousel-->
